...
public final class FavoriteGamesListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private FragmentGamesListBinding binding;

    @Inject BoardGamesInteractor interactor;
    private FavoriteGamesListViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        viewModel = new FavoriteGamesListViewModel(interactor);
