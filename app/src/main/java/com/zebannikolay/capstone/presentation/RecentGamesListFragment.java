...
public final class RecentGamesListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private FragmentGamesListBinding binding;

    @Inject BoardGamesInteractor interactor;
    private RecentGamesListViewModel viewModel;
    private UniversalRecyclerAdapter<BoardGamePreview> adapter;

    public RecentGamesListFragment() {}

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        App.getAppComponent().inject(this);
        viewModel = new RecentGamesListViewModel(interactor);
